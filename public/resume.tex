...
\textbf{MoSV: Mixture-of-Steering Vectors for LLM Hallucination Mitigation} $|$ \textit{Python, PyTorch}
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt, parsep=0pt]
...
\textbf{DYNAMO: Reinforcement Learning Portfolio Manager} $|$ \textit{Python, Stable-Baselines3}
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt, parsep=0pt]
