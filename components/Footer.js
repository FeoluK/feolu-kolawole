const links = [
  ...
  {
    name: 'Google Scholar',
    href: 'https://scholar.google.com/citations?user=--VbwJ0AAAAJ',
    icon: (
...
export default function Footer() {
  return (
    <footer className="mt-24 border-t border-rule pt-8 pb-12">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <p className="text-xs text-muted">© {new Date().getFullYear()} Feolu Kolawole</p>
      </div>
    </footer>
  )
}
